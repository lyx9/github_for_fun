...
Authors: chendong(chendong06@baidu.com)  liyixiang@baidu.com
Date:    2017-05-13 22:20:05
"""
import os
import sys
import csv
...
def Calculate(data_direct_path, is_filter, start_time=0, end_time=9999999):
    ...
    file_type_list = ['prediction.log', 'planning.log', 'control.log']
     #logs processing keywords: can be modified for other metric statics!
    
    key_words = [["Total Processing Time:",], ["] Predictor::predict:total", ], ["calc_time is:",]]
